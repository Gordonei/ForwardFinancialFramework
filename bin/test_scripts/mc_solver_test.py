...
def run_test_solver(platform_name,ssh_alias,cmd_option):
	...
	elif(platform_name in ["OpenCL_AlteraFPGA","OpenCL_XilinxFPGA"]): mc_solver = mc_solver_class(option,paths,platform,pipelining=1,instances=1,simd_width=1,kernel_path_max=1,cslow=False,simulation=True)
