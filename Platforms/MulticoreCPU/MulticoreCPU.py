...
class MulticoreCPU(Platform.Platform):
  ...
  def __init__(self,threads=multiprocessing.cpu_count(),platform_directory_string="Platforms/MulticoreCPU/multicore_c_code",root_directory_string=None,ssh_alias="",remote=False):
