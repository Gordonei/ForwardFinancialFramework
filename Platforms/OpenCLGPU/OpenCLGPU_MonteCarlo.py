...
class OpenCLGPU_MonteCarlo(MulticoreCPU_MonteCarlo.MulticoreCPU_MonteCarlo):
	...
	def generate(self,override=True,verbose=False,debug=False):
		...
		#Generate OpenCL Kernel Code
    		...
    		self.generate_source(self.kernel_code_list,".cl",verbose=verbose)
	...
	def generate_kernel_local_memory_structures(self):
		...
		output_list += self.generate_kernel_local_variable_arrays()
	...
	def generate_kernel_path_init(self):
		output_list = []
	...
	def generate_kernel_path_loop_body(self):
		output_list = []
	...
	def generate_kernel_path_payoff(self):
		output_list = []
