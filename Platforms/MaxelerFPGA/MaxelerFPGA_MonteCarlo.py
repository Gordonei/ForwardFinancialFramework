...
class MaxelerFPGA_MonteCarlo(MulticoreCPU_MonteCarlo.MulticoreCPU_MonteCarlo):
  ...
  def __init__(self,derivative,paths,platform,points=4096,reduce_underlyings=True,c_slow=False,pipelining=1,instances=1):
    self.c_slow = c_slow
  ...
  def generate_name(self):
      ...
      self.delay = self.get_delay() #Just making sure
      self.output_file_name = ("%s_cslow_%s_pipe_%d_insts_%d_delay_%d"%(self.output_file_name,str(self.c_slow),self.pipelining,self.instances,self.delay))
