...
public class digital_double_barrier_option extends double_barrier_option {
	...
	public digital_double_barrier_option(MC_Solver_Maxeler_Base_Kernel kernel, DFEVar pp, DFEVar p,DFEVar enable,digital_double_barrier_option_parameters ddbop) {
