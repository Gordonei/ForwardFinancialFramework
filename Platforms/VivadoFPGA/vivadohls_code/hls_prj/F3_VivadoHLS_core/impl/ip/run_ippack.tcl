...
set Interfaces {
    ...
    thread_result_sqrd_0 {
        type "axi4stream"
        mode "master"
        port_prefix "thread_result_sqrd_0"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    aclk {
        type "clock"
        buses "S_AXI_CORE_IO seed_0_offset seed_0_s1 seed_0_s2 seed_0_s3 thread_result_0 thread_result_sqrd_0"
    }
    aresetn {
        type "reset"
    }
