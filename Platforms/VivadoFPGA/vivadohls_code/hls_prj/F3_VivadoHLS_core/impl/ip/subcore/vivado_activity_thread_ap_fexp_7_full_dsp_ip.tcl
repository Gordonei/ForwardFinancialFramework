...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name vivado_activity_thread_ap_fexp_7_full_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name vivado_activity_thread_ap_fexp_7_full_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips vivado_activity_thread_ap_fexp_7_full_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis} [get_files vivado_activity_thread_ap_fexp_7_full_dsp.xci]
