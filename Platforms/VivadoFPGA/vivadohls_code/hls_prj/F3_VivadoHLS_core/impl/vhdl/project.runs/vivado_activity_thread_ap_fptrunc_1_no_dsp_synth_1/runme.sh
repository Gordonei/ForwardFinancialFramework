...
EAStep vivado -log vivado_activity_thread_ap_fptrunc_1_no_dsp.rds -m64 -mode batch -messageDb vivado.pb -source vivado_activity_thread_ap_fptrunc_1_no_dsp.tcl
