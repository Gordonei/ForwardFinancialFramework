...
EAStep vivado -log vivado_activity_thread_ap_dexp_13_full_dsp.rds -m64 -mode batch -messageDb vivado.pb -source vivado_activity_thread_ap_dexp_13_full_dsp.tcl
