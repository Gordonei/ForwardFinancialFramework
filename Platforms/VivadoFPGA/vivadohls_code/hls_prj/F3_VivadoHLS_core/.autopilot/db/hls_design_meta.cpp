...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("seed_0_s1", 32, hls_in, 20, "ap_none", "in_data", 1),
	Port_Property("seed_0_s2", 32, hls_in, 21, "ap_none", "in_data", 1),
	Port_Property("seed_0_s3", 32, hls_in, 22, "ap_none", "in_data", 1),
	Port_Property("seed_0_offset", 32, hls_in, 23, "ap_none", "in_data", 1),
	Port_Property("thread_result_0", 32, hls_out, 24, "ap_vld", "out_data", 1),
	Port_Property("thread_result_0_ap_vld", 1, hls_out, 24, "ap_vld", "out_vld", 1),
	Port_Property("thread_result_sqrd_0", 32, hls_out, 25, "ap_vld", "out_data", 1),
	Port_Property("thread_result_sqrd_0_ap_vld", 1, hls_out, 25, "ap_vld", "out_vld", 1),
};
