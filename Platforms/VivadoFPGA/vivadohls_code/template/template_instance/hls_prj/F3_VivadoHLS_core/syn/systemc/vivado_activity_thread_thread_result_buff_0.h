...
#ifndef _vivado_activity_thread_thread_result_buff_0_H_
#define _vivado_activity_thread_thread_result_buff_0_H_
...
struct vivado_activity_thread_thread_result_buff_0_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(vivado_activity_thread_thread_result_buff_0_core);
    vivado_activity_thread_thread_result_buff_0_core(sc_core::sc_module_name) {
    ...
    ~vivado_activity_thread_thread_result_buff_0_core() {
        delete [] mem;
    }
...
SC_MODULE( vivado_activity_thread_thread_result_buff_0 )
{
    ...
    SC_CTOR( vivado_activity_thread_thread_result_buff_0 ) {
        meminst = new vivado_activity_thread_thread_result_buff_0_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    vivado_activity_thread_thread_result_buff_0_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_vivado_activity_thread_thread_result_buff_0_H_
