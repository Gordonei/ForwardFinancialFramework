...
@p_str = private unnamed_addr constant [13 x i8] c"PATHSET_LOOP\00", align 1
@p_str1 = private unnamed_addr constant [10 x i8] c"PATH_LOOP\00", align 1
...
@p_str127 = private unnamed_addr constant [7 x i8] c"ap_bus\00", align 1
@p_str128 = private unnamed_addr constant [6 x i8] c"AXI4M\00", align 1
@p_str129 = private unnamed_addr constant [10 x i8] c"AXI_SLAVE\00", align 1
@p_str130 = private unnamed_addr constant [20 x i8] c"-bus_bundle CORE_IO\00", align 1
@p_str131 = private unnamed_addr constant [8 x i8] c"ap_none\00", align 1
@p_str132 = private unnamed_addr constant [10 x i8] c"AXI4LiteS\00", align 1
...
@str663 = internal constant [1 x i8] zeroinitializer
@p_str664 = internal constant [18 x i8] c"burstwrite.region\00"
...
define void @vivado_activity_thread(i32* %a, float* %kernel_u_a_0_rfir, float* %kernel_u_a_0_current_price, float* %kernel_u_a_0_volatility, float* %kernel_u_a_0_initial_volatility, float* %kernel_u_a_0_volatility_volatility, float* %kernel_u_a_0_rho, float* %kernel_u_a_0_kappa, float* %kernel_u_a_0_theta, float* %kernel_u_a_0_correlation_matrix_0_0, float* %kernel_u_a_0_correlation_matrix_0_1, float* %kernel_u_a_0_correlation_matrix_1_0, float* %kernel_u_a_0_correlation_matrix_1_1, float* %kernel_o_a_0_second_barrier, float* %kernel_o_a_0_barrier, float* %kernel_o_a_0_out, float* %kernel_o_a_0_down, float* %kernel_o_a_0_strike_price, float* %kernel_o_a_0_time_period, float* %kernel_o_a_0_call, float* %kernel_o_a_0_points, i32* %seed_0_s1, i32* %seed_0_s2, i32* %seed_0_s3, i32* %seed_0_offset, i32 %thread_result_0) {
  %spot_price_0_i = alloca float, align 4
  ...
  %thread_result_buff_0 = alloca [1000 x i32], align 16
  %thread_result_buff_0_0 = alloca [1000 x i32], align 16
  call void (...)* @_ssdm_op_SpecBus(i32* %a, [7 x i8]* @p_str127, i32 0, i32 0, i32 0, [1 x i8]* @p_str2) nounwind
  call void (...)* @_ssdm_op_SpecIFCore(i32* %a, [1 x i8]* @p_str2, [6 x i8]* @p_str128, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2)
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i32* %seed_0_s1, i32* %seed_0_s2, i32* %seed_0_s3, i32* %seed_0_offset, [1 x i8]* @p_str2, [10 x i8]* @p_str129, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [20 x i8]* @p_str130)
  call void (...)* @_ssdm_op_SpecWire(i32 %thread_result_0, [8 x i8]* @p_str131, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  call void (...)* @_ssdm_op_SpecIFCore(i32 %thread_result_0, [1 x i8]* @p_str2, [10 x i8]* @p_str132, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [20 x i8]* @p_str130)
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str2, [10 x i8]* @p_str129, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [20 x i8]* @p_str130)
  ...
  %delta_time_0 = fmul float %o_a_0_time_period, 0x3F30000000000000
  %tmp_i_i = fmul float %delta_time_0, %u_a_0_rfir
  %tmp_3 = fcmp oeq float %o_a_0_call, 0.000000e+00
  %tmp_4 = xor i1 %tmp_3, true
  br label %1

; <label>:1                                       ; preds = %_ifconv.i, %0
  %p_i = phi i10 [ 0, %0 ], [ %p_2, %_ifconv.i ]
  %exitcond2_i = icmp eq i10 %p_i, -24
  %p_2 = add i10 %p_i, 1
  br i1 %exitcond2_i, label %vivado_kernel_loop.exit, label %2
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_3_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str)
  br label %3

; <label>:3                                       ; preds = %4, %2
  %u_v_0_gamma_read_assign = phi float [ 0.000000e+00, %2 ], [ %u_v_0_arr_0_gamma, %4 ]
  %pp_i = phi i13 [ 0, %2 ], [ %pp, %4 ]
  %exitcond_i = icmp eq i13 %pp_i, -4096
  %pp = add i13 %pp_i, 1
  br i1 %exitcond_i, label %_ifconv.i, label %4
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_4_i = call i32 (...)* @_ssdm_op_SpecRegionBegin([10 x i8]* @p_str1)
  call void (...)* @_ssdm_op_SpecPipeline(i32 0, i32 2, i32 1, [1 x i8]* @p_str2) nounwind
  %u_v_0_arr_0_gamma = fadd float %tmp_i_i, %u_v_0_gamma_read_assign
  %tmp_6_i = call float @llvm.exp.f32(float %u_v_0_arr_0_gamma)
  %spot_price_0 = fmul float %tmp_6_i, %u_a_0_current_price
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([10 x i8]* @p_str1, i32 %tmp_4_i)
  store float %spot_price_0, float* %spot_price_0_i, align 4
  br label %3

_ifconv.i:                                        ; preds = %3
  %spot_price_0_i_load = load float* %spot_price_0_i, align 4
  %tmp_1_i_i = fsub float %spot_price_0_i_load, %o_a_0_strike_price
  %tmp_2_i_i = fsub float %o_a_0_strike_price, %spot_price_0_i_load
  %o_v_0_arr_0_value = select i1 %tmp_4, float %tmp_1_i_i, float %tmp_2_i_i
  %value_0 = bitcast float %o_v_0_arr_0_value to i32
  %tmp_i = zext i10 %p_i to i64
  %thread_result_buff_0_0_addr_1 = getelementptr [1000 x i32]* %thread_result_buff_0_0, i64 0, i64 %tmp_i
  store i32 %value_0, i32* %thread_result_buff_0_0_addr_1, align 4
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str, i32 %tmp_3_i)
  br label %1

vivado_kernel_loop.exit:                          ; preds = %1, %5
  %p = phi i10 [ %p_1, %5 ], [ 0, %1 ]
  %exitcond = icmp eq i10 %p, -24
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1000, i64 1000, i64 1000)
  %p_1 = add i10 %p, 1
  br i1 %exitcond, label %6, label %5

; <label>:5                                       ; preds = %vivado_kernel_loop.exit
  %tmp_1 = zext i10 %p to i64
  %thread_result_buff_0_0_addr = getelementptr inbounds [1000 x i32]* %thread_result_buff_0_0, i64 0, i64 %tmp_1
  %thread_result_buff_0_0_load = load i32* %thread_result_buff_0_0_addr, align 4
  %thread_result_buff_0_addr = getelementptr inbounds [1000 x i32]* %thread_result_buff_0, i64 0, i64 %tmp_1
  store i32 %thread_result_buff_0_0_load, i32* %thread_result_buff_0_addr, align 4
  br label %vivado_kernel_loop.exit
...
; <label>:6                                       ; preds = %vivado_kernel_loop.exit
  ...
  %tmp_8 = zext i30 %tmp to i64
  %a_addr = getelementptr inbounds i32* %a, i64 %tmp_8
  br label %burst.wr.header

burst.wr.body1:                                   ; preds = %burst.wr.header
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1000, i64 1000, i64 1000)
  %burstwrite_rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin([18 x i8]* @p_str664)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @str663)
  %tmp_2 = zext i10 %indvar to i64
  %thread_result_buff_0_addr_1 = getelementptr [1000 x i32]* %thread_result_buff_0, i64 0, i64 %tmp_2
  %thread_result_buff_0_load = load i32* %thread_result_buff_0_addr_1, align 4
...
burst.wr.body3:                                   ; preds = %burst.wr.body2, %burst.wr.body1
  ...
  %burstwrite_rend = call i32 (...)* @_ssdm_op_SpecRegionEnd([18 x i8]* @p_str664, i32 %burstwrite_rbegin)
  br label %burst.wr.header

burst.wr.header:                                  ; preds = %burst.wr.body3, %6
  %indvar = phi i10 [ %indvar_next, %burst.wr.body3 ], [ 0, %6 ]
  %exitcond1 = icmp eq i10 %indvar, -24
