...
set SourceFlags {sc {} c {{-DFP_t=float -DVIVADOHLS} {-DFP_t=float -DVIVADOHLS} {-DFP_t=float -DVIVADOHLS} {-DFP_t=float -DVIVADOHLS} {-DFP_t=float -DTAUS_BOXMULLER -DVIVADOHLS} {-DFP_t=float -DVIVADOHLS} {-DFP_t=float -DVIVADOHLS} {-DFP_t=float -DVIVADOHLS} {-DTAUS_BOXMULLER -DFP_t=float -DVIVADOHLS} {-DFP_t=float -DTAUS_BOXMULLER -DVIVADOHLS} {-DTAUS_BOXMULLER -DFP_t=float}}}
set DirectiveFile {/mnt/cas_nfs/gi11/workspace/scratch/ForwardFinancialFramework/Platforms/VivadoFPGA/vivadohls_code/hls_prj/F3_VivadoHLS_core/F3_VivadoHLS_core.directive}
