...
set C_modelArgMapList {[ 
	{ "rtlName" : "a","bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "rtlName" : "seed_0_s1","bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "seed_0.s1","cData": "unsigned int","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "rtlName" : "seed_0_s2","bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "seed_0.s2","cData": "unsigned int","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "rtlName" : "seed_0_s3","bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "seed_0.s3","cData": "unsigned int","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "rtlName" : "seed_0_offset","bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "seed_0.offset","cData": "unsigned int","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "rtlName" : "thread_result_0","bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "thread_result_0","cData": "unsigned int","cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} ]}
...
set portList { 
	...
	{ kernel_u_a_0_rfir sc_in sc_lv 32 signal 1 } 
	{ kernel_u_a_0_current_price sc_in sc_lv 32 signal 2 } 
	{ kernel_u_a_0_volatility sc_in sc_lv 32 signal 3 } 
	{ kernel_u_a_0_initial_volatility sc_in sc_lv 32 signal 4 } 
	{ kernel_u_a_0_volatility_volatility sc_in sc_lv 32 signal 5 } 
	{ kernel_u_a_0_rho sc_in sc_lv 32 signal 6 } 
	{ kernel_u_a_0_kappa sc_in sc_lv 32 signal 7 } 
	{ kernel_u_a_0_theta sc_in sc_lv 32 signal 8 } 
	{ kernel_u_a_0_correlation_matrix_0_0 sc_in sc_lv 32 signal 9 } 
	{ kernel_u_a_0_correlation_matrix_0_1 sc_in sc_lv 32 signal 10 } 
	{ kernel_u_a_0_correlation_matrix_1_0 sc_in sc_lv 32 signal 11 } 
	{ kernel_u_a_0_correlation_matrix_1_1 sc_in sc_lv 32 signal 12 } 
	{ kernel_o_a_0_second_barrier sc_in sc_lv 32 signal 13 } 
	{ kernel_o_a_0_barrier sc_in sc_lv 32 signal 14 } 
	{ kernel_o_a_0_out sc_in sc_lv 32 signal 15 } 
	{ kernel_o_a_0_down sc_in sc_lv 32 signal 16 } 
	{ kernel_o_a_0_strike_price sc_in sc_lv 32 signal 17 } 
	{ kernel_o_a_0_time_period sc_in sc_lv 32 signal 18 } 
	{ kernel_o_a_0_call sc_in sc_lv 32 signal 19 } 
	{ kernel_o_a_0_points sc_in sc_lv 32 signal 20 } 
	{ seed_0_s1 sc_in sc_lv 32 signal 21 } 
	{ seed_0_s2 sc_in sc_lv 32 signal 22 } 
	{ seed_0_s3 sc_in sc_lv 32 signal 23 } 
	{ seed_0_offset sc_in sc_lv 32 signal 24 } 
	{ thread_result_0 sc_in sc_lv 32 signal 25 } 
}
...
set Spec2ImplPortList { 
	...
	thread_result_0 { ap_none {  { thread_result_0 in_data 0 32 } } }
}
