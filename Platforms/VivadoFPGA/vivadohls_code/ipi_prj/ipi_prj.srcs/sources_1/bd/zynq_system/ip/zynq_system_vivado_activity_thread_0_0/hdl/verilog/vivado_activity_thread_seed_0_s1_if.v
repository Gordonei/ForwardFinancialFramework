...
module vivado_activity_thread_seed_0_s1_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [31:0] seed_0_s1_dout,
    output wire        seed_0_s1_empty_n,
    input  wire        seed_0_s1_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [31:0] seed_0_s1_din;
wire [0:0]  seed_0_s1_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
//------------------------Instantiation------------------
// rs
vivado_activity_thread_seed_0_s1_reg_slice #(
    .N       ( 32 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// seed_0_s1_fifo
vivado_activity_thread_seed_0_s1_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) seed_0_s1_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( seed_0_s1_empty_n ),
    .full_n     ( seed_0_s1_full_n ),
    .read       ( seed_0_s1_read ),
    .write      ( fifo_write ),
    .dout       ( seed_0_s1_dout ),
    .din        ( seed_0_s1_din )
...
assign seed_0_s1_din = m_data[31:0];
assign fifo_full_n   = seed_0_s1_full_n;
...
module vivado_activity_thread_seed_0_s1_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module vivado_activity_thread_seed_0_s1_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
