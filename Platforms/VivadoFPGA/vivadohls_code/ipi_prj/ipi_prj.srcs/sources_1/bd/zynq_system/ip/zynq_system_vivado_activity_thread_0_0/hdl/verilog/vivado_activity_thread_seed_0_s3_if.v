...
module vivado_activity_thread_seed_0_s3_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [31:0] seed_0_s3_dout,
    output wire        seed_0_s3_empty_n,
    input  wire        seed_0_s3_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
wire [0:0]  fifo_full_n;
wire [31:0] seed_0_s3_din;
wire [0:0]  seed_0_s3_full_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
//------------------------Instantiation------------------
// rs
vivado_activity_thread_seed_0_s3_reg_slice #(
    .N       ( 32 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// seed_0_s3_fifo
vivado_activity_thread_seed_0_s3_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) seed_0_s3_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( seed_0_s3_empty_n ),
    .full_n     ( seed_0_s3_full_n ),
    .read       ( seed_0_s3_read ),
    .write      ( fifo_write ),
    .dout       ( seed_0_s3_dout ),
    .din        ( seed_0_s3_din )
...
assign seed_0_s3_din = m_data[31:0];
assign fifo_full_n   = seed_0_s3_full_n;
...
module vivado_activity_thread_seed_0_s3_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module vivado_activity_thread_seed_0_s3_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
