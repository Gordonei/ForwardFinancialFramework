...
static FP_t double_barrier_option_0_time_period;
static FP_t double_barrier_option_0_call;
static FP_t double_barrier_option_0_strike_price;
static FP_t double_barrier_option_0_points;
static FP_t double_barrier_option_0_barrier;
static FP_t double_barrier_option_0_out;
static FP_t double_barrier_option_0_down;
static FP_t double_barrier_option_0_second_barrier;
static int paths;
...
typedef struct{
	...
	double_barrier_option_attributes o_a_0;
	} kernel_data;
...
void vivado_activity_thread(volatile int *a,standard_underlying_attributes *kernel_u_a_0,standard_derivative_attributes *kernel_o_a_0,rng_state_t *seed_0,unsigned int thread_result_0){
	...
	double_barrier_option_attributes o_a_0;
	double_barrier_option_variables *o_v_0;
	double_barrier_option_variables o_v_0_arr[1];
	o_v_0 = o_v_0_arr;

	//***Derivative Attributes Initialisation***
	double_barrier_option_derivative_init(kernel_o_a_0->time_period,kernel_o_a_0->call,kernel_o_a_0->strike_price,kernel_o_a_0->points,kernel_o_a_0->barrier,kernel_o_a_0->out,kernel_o_a_0->down,kernel_o_a_0->second_barrier,&o_a_0);
	...
	PATHSET_LOOP: for(p=0;p<PATHS;++p){
		...
		time_0 = u_v_0->time;
		double_barrier_option_derivative_path_init(o_v_0,&o_a_0);
		delta_time_0 = o_a_0.time_period/PATH_POINTS;

		//**Running the path**
		PATH_LOOP: for(pp=0;pp<(PATH_POINTS);++pp){
			double_barrier_option_derivative_path(spot_price_0,time_0,o_v_0,&o_a_0);
		...
		double_barrier_option_derivative_payoff(spot_price_0,o_v_0,&o_a_0);
...
void * multicore_montecarlo_activity_thread(void* thread_arg){
	...
	double_barrier_option_derivative_init(double_barrier_option_0_time_period,double_barrier_option_0_call,double_barrier_option_0_strike_price,double_barrier_option_0_points,double_barrier_option_0_barrier,double_barrier_option_0_out,double_barrier_option_0_down,double_barrier_option_0_second_barrier,&o_a_0);
...
int main(int argc,char* argv[]){
	...
	double_barrier_option_0_time_period = strtod(argv[18],NULL);
	double_barrier_option_0_call = strtod(argv[19],NULL);
	double_barrier_option_0_strike_price = strtod(argv[20],NULL);
	double_barrier_option_0_points = strtod(argv[21],NULL);
	double_barrier_option_0_barrier = strtod(argv[22],NULL);
	double_barrier_option_0_out = strtod(argv[23],NULL);
	double_barrier_option_0_down = strtod(argv[24],NULL);
	double_barrier_option_0_second_barrier = strtod(argv[25],NULL);

	//**Calculating Discount Factor**
	discount_0_0 = exp(-heston_underlying_0_rfir*double_barrier_option_0_time_period);
