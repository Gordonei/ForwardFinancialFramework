; ModuleID = '/home/ee/s/sf306/ForwardFinancialFramework/Platforms/VivadoFPGA/hls_prj/F3_VivadoHLS_core/.autopilot/db/a.o.2.bc'
...
.preheader:                                       ; preds = %1, %2
  ...
  %tmp_pn = phi float [ %tmp_8, %2 ], [ 1.000000e+00, %1 ]
  %j = phi i4 [ %j_1, %2 ], [ 0, %1 ]
...
; <label>:2                                       ; preds = %.preheader
  ...
  %tmp_8 = call float @llvm.exp.f32(float %u_v_0_gamma)
  br label %.preheader

_ifconv:                                          ; preds = %.preheader
  %tmp_1_i = fsub float %spot_price_0_1, %o_a_0_strike_price
  %tmp_2_i = fsub float %o_a_0_strike_price, %spot_price_0_1
  %o_v_0_value = select i1 %tmp_1, float %tmp_1_i, float %tmp_2_i
