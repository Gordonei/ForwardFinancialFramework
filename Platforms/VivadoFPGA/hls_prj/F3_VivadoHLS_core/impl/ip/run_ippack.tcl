...
set Vendor      "imperial"
set Library     "F3"
set IPName      "vivado_activity_thread"
set Version     "1.0"
set DisplayName "Vivado_activity_thread"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "vivado_activity_thread_top"
...
set Interfaces {
    S_AXI_CORE_IO {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_CORE_IO"
        param_prefix "C_S_AXI_CORE_IO"
        addr_bits "7"
    }
    interrupt {
        type "interrupt"
    ...
    switch -- [lindex $Type 0] {
        ...
        real {
            ...
            if {$sub_type == "fixed"} {
                ...
                # real -float
                return [iptypes::datatype::new -type real -bitwidth $Width -bitoffset $bitoffset -float]
            }
        }
        ...
        complex {
            ...
            switch -- [lindex $Type 0] {
                integer {
                    ...
                    return [iptypes::datatype::new -type complex -bitwidth $Width -stride $Width -bitoffset $bitoffset -integer -signed $signed]
                }
                ...
                real {
                    ...
                    if {$sub_type == "fixed"} {
                        ...
                        return [iptypes::datatype::new -type complex -bitwidth $Width -stride $Width -bitoffset $bitoffset -real -fixed \
                            -signed $signed -fractwidth $frac_width]
                    } else {
                        # real -float
                        return [iptypes::datatype::new -type complex -bitwidth $Width -stride $Width -bitoffset $bitoffset -real -float]
                    }
                }
            }
        }
        ...
        struct {
            ...
            dict for {field_name field_type} $Fields {
                ...
                incr i [dict get $field_type Width]
            }
        ...
        array {
            set size [lindex $Dimensions 0]
            set Width [expr $Width / $size]
            if {[llength $Dimensions] > 1} {
                dict set ctype Dimensions [lrange $Dimensions 1 end]
                dict set ctype Width $Width
                return [iptypes::datatype::new -type array_type -bitoffset $bitoffset -size $size \
                    -stride $Width -datatype [create_datatype $ctype]]
            } else {
                return [iptypes::datatype::new -type array_type -bitoffset $bitoffset -size $size \
                    -stride $Width -datatype [create_datatype $Element]]
            }
        }
...
foreach f [concat $SynVerilogFiles $IPFiles $ConstraintFiles] {
