...
architecture behav of vivado_activity_thread is 
    ...
    "vivado_activity_thread,hls_ip_2013_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.626000,HLS_SYN_LAT=189,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=0}";
    ...
    signal tmp_i_reg_267 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_216_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_reg_272 : STD_LOGIC_VECTOR (0 downto 0);
    signal spot_price_0_1_reg_277 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_1_fu_228_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_1_reg_287 : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_fu_192_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal u_v_0_gamma_reg_292 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_211_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal o_v_0_value_fu_234_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal o_v_0_value_reg_303 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start , ap_CS_fsm , k_phi_fu_148_p4 , exitcond_fu_222_p2)
    begin
        case ap_CS_fsm is
    ...
    exitcond_fu_222_p2 <= "1" when (j_reg_180 = ap_const_lv4_A) else "0";
    grp_fu_192_ce <= ap_const_logic_1;

    -- grp_fu_192_opcode assign process. --
    grp_fu_192_opcode_assign_proc : process(ap_CS_fsm, tmp_1_reg_272, exitcond_fu_222_p2)
    begin
        if ((((ap_ST_st23_fsm_22 = ap_CS_fsm) and not((tmp_1_reg_272 = ap_const_lv1_0))) or ((ap_ST_st23_fsm_22 = ap_CS_fsm) and (tmp_1_reg_272 = ap_const_lv1_0)))) then 
            grp_fu_192_opcode <= ap_const_lv2_1;
        elsif (((ap_ST_st28_fsm_27 = ap_CS_fsm) or ((ap_ST_st9_fsm_8 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond_fu_222_p2)))) then 
    ...
    grp_fu_192_p0_assign_proc : process(ap_CS_fsm, thread_arg_o_a_0_strike_price, tmp_i_reg_267, tmp_1_reg_272, spot_price_0_1_reg_277, temp_total_0_reg_130)
    begin
        if ((ap_ST_st28_fsm_27 = ap_CS_fsm)) then 
            grp_fu_192_p0 <= temp_total_0_reg_130;
        elsif (((ap_ST_st23_fsm_22 = ap_CS_fsm) and (tmp_1_reg_272 = ap_const_lv1_0))) then 
            grp_fu_192_p0 <= thread_arg_o_a_0_strike_price;
        elsif (((ap_ST_st23_fsm_22 = ap_CS_fsm) and not((tmp_1_reg_272 = ap_const_lv1_0)))) then 
    ...
    grp_fu_192_p1_assign_proc : process(ap_CS_fsm, thread_arg_o_a_0_strike_price, tmp_1_reg_272, spot_price_0_1_reg_277, o_v_0_value_reg_303, u_v_gamma_read_assign_reg_168)
    begin
        if ((ap_ST_st28_fsm_27 = ap_CS_fsm)) then 
    ...
    grp_fu_211_p1 <= u_v_0_gamma_reg_292;
    j_1_fu_228_p2 <= std_logic_vector(unsigned(j_reg_180) + unsigned(ap_const_lv4_1));
    k_phi_fu_148_p4 <= k_reg_143;
    o_v_0_value_fu_234_p3 <= 
        grp_fu_192_p2 when (tmp_1_reg_272(0) = '1') else 
        grp_fu_192_p2;
    ...
    tmp_1_fu_216_p2 <= (grp_fu_205_p2 xor ap_const_lv1_1);
end behav;
