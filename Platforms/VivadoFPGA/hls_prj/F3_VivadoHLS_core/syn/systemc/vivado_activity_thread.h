...
struct vivado_activity_thread : public sc_module {
    ...
    sc_signal< sc_lv<1> > tmp_reg_266;
    sc_signal< sc_lv<32> > grp_fu_198_p2;
    sc_signal< sc_lv<32> > tmp_i_reg_271;
    sc_signal< sc_lv<1> > tmp_1_fu_216_p2;
    sc_signal< sc_lv<1> > tmp_1_reg_276;
    sc_signal< sc_lv<32> > spot_price_0_1_reg_281;
    sc_signal< sc_lv<4> > j_1_fu_227_p2;
    sc_signal< sc_lv<4> > j_1_reg_291;
    sc_signal< sc_lv<32> > grp_fu_192_p2;
    sc_signal< sc_lv<32> > u_v_0_gamma_reg_296;
    sc_signal< sc_lv<32> > grp_fu_211_p2;
    sc_signal< sc_lv<32> > o_v_0_value_fu_233_p3;
    sc_signal< sc_lv<32> > o_v_0_value_reg_307;
    ...
    void thread_o_v_0_value_fu_233_p3();
